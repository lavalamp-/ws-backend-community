...
urlpatterns = [
    ...
    # url(r'^organizations/(?P<pk>[-\w]+)/domain-names/analytics/?$', views.OrganizationDomainNameReportAnalyticsAPIView.as_view(), name="organizationdomainname-analytics"),
    # url(r'^organizations/(?P<pk>[-\w]+)/domain-names/?$', views.OrganizationDomainNameReportListAPIView.as_view(), name="organizationdomainname-list"),
    url(r'^organizations/(?P<pk>[-\w]+)/ssl-support/analytics/$', views.OrganizationSslSupportReportAnalyticsAPIView.as_view(), name="organizationsslsupport-analytics"),
    url(r'^organizations/(?P<pk>[-\w]+)/ssl-support/$', views.OrganizationSslSupportReportListAPIView.as_view(), name="organizationsslsupport-list"),
    ...
    url(r'^organizations/(?P<pk>[-\w]+)/web-tech-reports/analytics/$', views.OrganizationWebTechReportAnalyticsAPIView.as_view(), name="organizationwebtechreport-analytics"),
    url(r'^organizations/(?P<pk>[-\w]+)/web-tech-reports/$', views.OrganizationWebTechReportListAPIView.as_view(), name="organizationwebtechreport-list"),
    url(r'^organizations/(?P<pk>[-\w]+)/web-transactions/analytics/$', views.OrganizationWebTransactionAnalyticsAPIView.as_view(), name="organizationwebtransaction-analytics"),
    url(r'^organizations/(?P<pk>[-\w]+)/web-transactions/$', views.OrganizationWebTransactionListAPIView.as_view(), name="organizationwebtransaction-list"),
    url(r'^organizations/(?P<pk>[-\w]+)/web-screenshots/$', views.OrganizationWebScreenshotsListAPIView.as_view(), name="organizationwebscreenshot-list"),
    url(r'^organizations/(?P<pk>[-\w]+)/web-services/analytics/$', views.OrganizationWebServiceReportAnalyticsAPIView.as_view(), name="organizationwebreport-analytics"),
    url(r'^organizations/(?P<pk>[-\w]+)/web-services/$', views.OrganizationWebServiceReportListAPIView.as_view(), name="organizationwebreport-list"),
    ...
    url(r'^web-services/(?P<pk>[-\w]+)/resources/?$', views.WebServiceResourceListAPIView.as_view(), name="webserviceresource-list"),
    url(r'^web-services/(?P<pk>[-\w]+)/http-screenshots/$', views.WebServiceScreenshotListAPIView.as_view(), name="webservicescreenshot-list"),
    url(r'^web-services/(?P<pk>[-\w]+)/http-transactions/analytics/$', views.WebServiceHttpTransactionAnalyticsAPIView.as_view(), name="webservicetransaction-analytics"),
    url(r'^web-services/(?P<pk>[-\w]+)/http-transactions/$', views.WebServiceHttpTransactionListAPIView.as_view(), name="webservicetransaction-list"),
    ...
    url(r'^domain-names/(?P<pk>[-\w]+)/report/?$', views.DomainNameReportDetailAPIView.as_view(), name="domainreport-detail"),
