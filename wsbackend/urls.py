...
urlpatterns = [
    ...
    url(r'^organizations/(?P<pk>[-\w]+)/es/ssl-support/by-domain/(?P<domain>[^/]+)/?$', views.SslSupportReportByDomainListAPIView.as_view(), name="organizationsslsupportbydomain-list"),
    url(r'^organizations/(?P<pk>[-\w]+)/es/ssl-support/by-ip/(?P<ip>[^/]+)/?$', views.SslSupportReportByIpListAPIView.as_view(), name="organizationsslsupportbyip-list"),
